            ...
            {showHistory ? (
              ...
              comments.length === 0 ? (
                ...
                organizeComments().map((comment, index, all) => {
                  ...
                  const isFirstTimed = !isGeneral && (index === 0 || parseTimestampSeconds(all[index - 1]?.timestamp) === null);

                  return (
                    <div key={comment.id} className="space-y-4">
                      {isFirstGeneral && (
                        <div className="flex items-center gap-2 px-1 text-[9px] font-black uppercase tracking-[0.2em] text-zinc-600 mb-2">
                          <div className="w-1.5 h-1.5 bg-red-600" />
                          Feedback Geral
                        </div>
                      )}
                      {isFirstTimed && (
                        <div className="flex items-center gap-2 px-1 text-[9px] font-black uppercase tracking-[0.2em] text-zinc-600 mt-6 mb-2">
                        ...
                        >
                          <div>
                            <div className="flex items-center justify-between mb-1">
                              <span className={`text-[10px] font-black uppercase tracking-tighter ${isGeneral ? 'text-zinc-400' : 'text-red-600'}`}>
