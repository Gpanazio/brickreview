...
export function ProjectCoverPlaceholder({ className, projectName = "", clientName = "" }) {
  ...
  return (
    <div
      className={`w-full h-full bg-zinc-950 relative overflow-hidden flex flex-col items-center justify-center ${className}`}
    >
      ...
      <div className="absolute inset-0 opacity-20">
        {variation === 0 && (
          <div
            ...
            style={{
              backgroundImage:
                "linear-gradient(45deg, #18181b 25%, transparent 25%, transparent 75%, #18181b 75%, #18181b), linear-gradient(45deg, #18181b 25%, transparent 25%, transparent 75%, #18181b 75%, #18181b)",
        ...
        {variation === 2 && (
          <div
            ...
            style={{
              backgroundImage:
                "repeating-linear-gradient(45deg, transparent, transparent 5px, #18181b 5px, #18181b 10px)",
            }}
          />
        )}
      </div>
      ...
      <div className="relative z-10 flex flex-col items-center justify-center transform scale-[0.6] md:scale-100 origin-center w-full">
        ...
        <div className="w-10 h-10 border-2 border-[#27272a] flex items-center justify-center bg-black shadow-lg">
          <span
            className="font-sans text-xl text-white font-black tracking-tighter"
        ...
        {projectName.length > 0 && (
          <span
            className="font-mono text-[8px] text-[#71717a] uppercase tracking-widest font-bold max-w-[60px] truncate text-center"
