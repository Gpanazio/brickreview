        ...
        <div className="glass-panel p-10 border border-zinc-800/50 relative overflow-hidden group">
          ...
          <div className="flex flex-col items-center mb-10">
            ...
            >
              ...
              <p className="text-zinc-500 text-[10px] font-bold uppercase tracking-[0.4em] leading-none">
                Video Review System
              </p>
            </motion.div>
          </div>
          ...
          >
            <p className="text-[9px] text-zinc-600 uppercase tracking-[0.4em] font-bold leading-relaxed">
              Acesso exclusivo para equipe <span className="text-zinc-400">Brick</span> e clientes
              autorizados
            </p>
          </motion.div>
        </div>
