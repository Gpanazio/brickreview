...
-- ============================================
-- PORTFOLIO COLLECTIONS & SHARING SYSTEM
-- ============================================

-- Portfolio Collections (folder-like organization for portfolio videos)
...
-- Indexes for portfolio_collections
...
-- Add collection_id to portfolio_videos
...
-- Portfolio Shares (token-based sharing system)
...
-- View for collections with stats
...
DROP TRIGGER IF EXISTS trigger_portfolio_collections_updated_at ON portfolio_collections;
