...
import { downloadFile, uploadFile } from "../utils/r2.js";
...
console.log(`   Alvo: ${specificVideoId ? `Vídeo ID ${specificVideoId}` : processAll ? "Todos sem sprites" : "Nenhum (use --all ou --video-id=X)"}`);
console.log("");
